                    ...
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <form action="{{route('auth.register')}}" method="post">
                                    ...
                                    <div class="row mb-3">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input name="user_name" class="form-control @error('user_name') is-invalid @enderror" id="inputUserName"
                                                       type="text" placeholder="Tên tài khoản"/>
                                                <label for="inputFirstName">Tên tài khoản</label>
                                            </div>
                                            @error('user_name')
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-3 mb-md-0">
                                                <input name="password_confirmation" class="form-control @error('password') is-invalid @enderror"
                            ...
                            <div class="card-footer text-center py-3">
                                <div class="small"><a href="">Bạn đã có tài khoản? Tới trang đăng
                                        nhập</a></div>
                            </div>
                        </div>
                    </div>
